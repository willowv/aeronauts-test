...
import { ScenarioReport, GetScenarioStats, getCombatStats, CombatStats } from './statistics';
...
export function AttackerBoost(terrain : Terrain[], attacker : Combatant, target : Combatant, attackType : Attack) : number {
