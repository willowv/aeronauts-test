...
export function RunPCAction(playerIndex : number, initialState : GameState) : GameState {
...
export function RunNPCAction(npcIndex : number, initialState : GameState) : GameState {
    let state = initialState.clone();
